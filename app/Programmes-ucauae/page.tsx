...
export default function ProgrammesSection() {
  const [activeTab, setActiveTab] = useState<"undergraduate" | "entry">(
    "undergraduate"
  );
      ...
      <div className="mx-auto max-w-7xl px-4">
        ...
        >
          <div>
            ...
            <h2 className="font-garage mt-4 text-[58px] font-black uppercase leading-[1.1] tracking-[-0.05em] md:text-[92px]">
              Our
              <br />
              Programmes
            </h2>
          ...
          <p className="max-w-md font-neue text-base leading-7 text-black md:text-lg">
...
<div className="flex min-h-[265px] flex-col p-7">
  <h3 className="font-garage text-[30px] font-black uppercase leading-[0.95] tracking-[-0.03em] transition group-hover:text-[#C8EB00]">
    {item.title}
  </h3>
